...
const GeneratedProjectModal = ({ isOpen, onRequestClose, project }) => {
  ...
  return (
    <Modal
      ...
      className={
        "bg-gray-300 shadow-xl h-[500px] overflow-y-auto overflow-x-hidden p-5 w-3/4 mt-10 absolute left-1/2 -translate-x-1/2 rounded-lg text-black"
      }
    >
      ...
      <div className="pb-2 border-b-2 border-b-white">
        ...
        <div className="mt-2">
          <p className="text-sm text-gray-700">{project.project.description}</p>
        </div>
      </div>
      <div className="p-3">
